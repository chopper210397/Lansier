...
data<-read_xlsx("C:/Users/LBarrios/Desktop/testgithub/Lansier/datapresentacion.xlsx") #borre todo el path que decia C/USERS,etc y lo deje solo en el nombre de el archivo, asi ya no importa donde lo corra siempre y cuando este en el wd
...
tabla %>%
  ...
  pack_rows("VENDEDORES Lima", 16, 19,color = "black") %>%
  row_spec(0,bold=T) %>% 
